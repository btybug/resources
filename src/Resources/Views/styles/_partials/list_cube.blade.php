                            ...
                            <div class="col-xs-12  col-md-6 col-lg-3">
                                <div class="row templates m-b-10" id="styles_div">
                                    ...
                                    <div class="col-xs-12 templates-header p-t-10 p-b-10 div_title_1">
                                        <button class="button_title" data-styleId="{{$style->style_id}}"
                                                ...
                                                @else
                                                    <a href="{!! url('admin/resources/styles/make-default',[$style->style_id,$style->id]) !!}"
                                        ...
                                        <div class="col-xs-12 templates-buttons text-center link_del">
                                            <a href="{!! url('admin/resources/styles/delete',[$style->id])  !!}"
