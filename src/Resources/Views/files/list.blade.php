            ...
            <div class="templates-list  m-t-20 m-b-10">
                <div class="row templates m-b-10">
                    ...
                    <div class="raw tpl-list">
                        @include('resources::files._partials.list_cube')
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['url'=>'/admin/resources/files/upload','class'=>'dropzone', 'id'=>'my-awesome-dropzone']) !!}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.list-unstyled').on('click', '.tpl-left-items', function (e) {
                ...
                $.ajax({
                    url: '/admin/resources/files/files-with-type',
                    data: {
                        main_type: main_type,
                        url: pageurl + '?rel=tab',
                        type: general_type
            ...
            $('body').on('click', '.del-tpl', function () {
                ...
                $.ajax({
                    url: '/admin/resources/files/delete',
                    data: {
                        slug: slug
                    },
                    headers: {
