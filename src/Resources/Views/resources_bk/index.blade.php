...
<div class="row">
 ...
 <li role="presentation" @if($key==0)class="active" @endif><i class="fa  fa-trash-o tabdelete text-danger" data-tab-delete="{{$group['id']}}"></i><a href="#{{$group['id']}}" data-id="{{$group['id']}}" class="p-l-20 p-r-20"  aria-controls="general" role="tab" data-toggle="tab">{{$group['term_name']}}</a></li>
            @endforeach
            

<li role="actionAddNew" class="pull-right"><a href="#" class="btn btn-success btn-xs text-white p-10 p-t-5 p-b-5 m-t-10" title="Add New section" data-toggle="modal" data-target="#AddNewSection"><i class="fa fa-plus"></i></a></li>
        ...
        <div class="p-10 bg-silver  overflow-y-hidden">
            <div class="tab-content m-10 p-15 bg-white overflow-y-hidden" id="sectioncontainer">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-default btn-success pull-right m-b-5" type="button" data-toggle="collapse" href=".uploadplugins"><i class="fa fa-plus"></i> Upload New Plugin</button>
                </div>
