                    ...
                    <table width="100%" class="table table-bordered m-0">
                        ...
                        @foreach($variations as $variation_data)
                            <tr>
                                ...
                                <td>
                                    @if(@$ui->have_settings)
                                        <a href="/admin/resources/widgets/settings/{{$variation_data->id}}"
                                           class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                    @endif

                                    <a href="/admin/resources/widgets/settings-live/{{$variation_data->id}}"
                                    ...
                                    @if($variation_data->default == 0)
                                        <a href="/admin/resources/widgets/make-default-variation/{{$variation_data->id}}/{{$ui->id}}"
                                           class="btn btn-primary btn-xs"> &nbsp;make default;</a>
                                        <a href="/admin/resources/widgets/delete-variation/{{$variation_data->id}}/{{$ui->id}}"
