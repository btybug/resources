        ...
        {{--@else--}}
                        ...
                        <table width="100%" class="table table-bordered m-0">
                            ...
                            @foreach($variations as $variation_data)
                                <tr>
                                    ...
                                    <td>
                                        @if(@$ui->have_settings)
                                            <a href="/admin/resources/widgets/settings/{{$variation_data->id}}" class="btn btn-default btn-warning btn-xs">&nbsp;<i class="fa fa-cog"></i>&nbsp;</a>
                                        @endif

                                        <a href="/admin/resources/widgets/settings-live/{{$variation_data->id}}" class="btn btn-primary btn-xs">&nbsp;<i class="fa fa-desktop"></i>&nbsp;</a>
                                        ...
                                        @if($variation_data->default == 0)
                                                <a href="/admin/resources/widgets/make-default-variation/{{$variation_data->id}}/{{$ui->id}}" class="btn btn-primary btn-xs"> &nbsp;make default;</a>
                                            <a href="/admin/resources/widgets/delete-variation/{{$variation_data->id}}/{{$ui->id}}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete')"> &nbsp;<i class="fa fa-trash"></i> &nbsp;</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="col-md-4 new-variation @if(empty($variation)) hide @endif">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::model('customiser',['method'=>'POST','url'=>'/admin/resources/widgets/widgets-variations/'.$ui->slug]) !!}
...
@section('JS')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.editable').editable({
                url: '/admin/resources/widgets/editvariation',
        ...
        $('.edit-variation').on('click',function(){
            ...
            $.ajax({
                type: "post",
                url: "{!! url('/admin/resources/widgets/get-variations') !!}",
                cache: false,
                datatype: "json",
                data:data,
                headers: {
