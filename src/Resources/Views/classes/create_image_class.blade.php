    ...
    <div class="row toolrowsection bootbox">
        ...
        <div class="col-md-6 p-t-15 p-r-15">
            <div class="text-left p-t-40 p-b-40 m-b-40" data-tool="preview">
                <div class="previewimageview"><img src="/public/img/Chrysanthemum.jpg" class="" data-role="classview"/>
                </div>
            ...
            <textarea class="form-control"
                    ...
                    {"class":"classname","savedcss":".classname{border-radius:5px; border-width:3px;
                    border-style:dotted; border-color:#ef0000; background-color:#ffffff; padding:13px; color:#9b2d2d;
                    }","classname":".classname","css":{"border-radius":"5px","border-width":"3px","border-style":"dotted","border-color":"#ef0000","background-color":"#ffffff","padding":"13px","color":"#992c2c"}}@endif</textarea>
            <h5>css</h5>
