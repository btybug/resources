...
<div class="row toolbarNav" style="padding-bottom:0px;">
  <div class="row">
    ...
    <div class="col-md-6 text-right"><a href="/admin/Resources/classes/buttons" class="btn btn-default btn-default-gray">Discard</a> <a href="#" class="btn btn-danger btn-danger-red" data-save="class">Save</a>
...
<div class="row toolrowsection bootbox">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8 p-0">
                <div class="form-inline p-0">
                  ...
                  <div class="checkbox radio ">
                    <input type="radio"  value="1"  data-value=":hover" data-rolecss="cssfor" name="cssfor">
                    <label> Hover </label>
                  </div>
  ...
  <div class="col-md-6 p-t-15 p-r-15">
    ...
    <textarea class="form-control" data-export="json">    @if(isset($variation)) {!! $variation->json_data
                !!}@else{"class":"classname","savedcss":".classname{}","classname":".classname","css":{}}@endif</textarea>
    <h5>css</h5>
