@extends('layouts.mTabs',['index'=>'classes'])
@section('parag')
  ...
  <div class="col-md-12 p-10">
    <div class="text-right">
      <button class="btn btn-warning btnadd" data-action="addnew" data-toggle="collapse"
                    data-target="#addnewform"><i class="fa fa-plus"></i> New Text Class </button>
    </div>
      ...
      <div class="panel panel-default" style="margin-top: 10px;">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group datafrom" data-type="uploadmedia" data-size="col-sm-12" data-fields="core">
                <div class="row">
                  <div data-fcontrol="input" class="col-sm-12 p-0">
                    <div class="col-md-6  p-0 p-b-10">
                      <label for="singleline" data-fcontrol="label" class="col-sm-12 control-label p-l-0">Upload Media</label>
                      <button data-role="browseMedia" class="btn btn-default" type="button">Select Image</button>
                    </div>
          ...
          <button type="submit" class="btn btn-success save m-l-10" data-action="save" data-role="addnew">Save </button>
        </div>
      </div>
    </div>
    {!! Form::close() !!} </div>
...
<div class="container col-md-12"> {{--<a href="{!! url('/admin/resources/classes/create-text-class') !!}" class="btn btn-success" style="float: right;">+new--}}
  ...
  <table class="table table-bordered m-0">
    ...
    <tr>
      <td><div style="display: block;overflow: hidden;max-width: 50%;max-height: 100px;"> <img src="{!! $class->image !!}"> </div></td>
      <td><a data-pk="{{$class->id}}" style="cursor: pointer;" class="editable editable-click" >{!! $class->name !!}</a></td>
      ...
      <td>
          ...
          >
              ...
              @endif
              <a href="{!! url('/admin/resources/classes/variation-class',$class->id)!!}" class="btn btn-success">
