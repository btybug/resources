            ...
            <div class="row templates m-b-10">
                <div class="col-xs-12 p-l-0 p-r-0">
                    ...
                    <div class="tempalte_icon">
                        <div><a href="{!! url('admin/resources/classes/variation-class',$class->id) !!}" class="m-r-10"><i class="fa fa-desktop f-s-14"></i> </a></div>
                        <div><a href="{!! url('admin/resources/classes/settings',$class->id) !!}" class="m-r-10"><i class="fa fa-cog f-s-14"></i> </a></div>
                ...
                <div class="col-xs-12 templates-header p-t-10 p-b-10">
                    <span class="col-xs-12 templates-title f-s-15 text-center"><i class="fa fa-bars f-s-13 m-r-5" aria-hidden="true"></i>  {!! $class->name !!}</span>
