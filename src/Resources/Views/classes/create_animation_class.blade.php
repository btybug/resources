    ...
    <div class="row toolrowsection bootbox">
        <div class="col-md-6 tooleditsection">
            <div id="panelTool">
              ...
              <div class="col-sm-8">
                <select class="form-control" data-css="animation-name" data-selector="animationname" data-width="130px">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                <div class="fullSliderw settingSlider greenSlider m-t-5" data-css="animation-delay" data-css-after="s" data-slide-min="0" data-slide-max="10" data-slide-step="0.1" data-slide-val="0.1"> </div>
                              </div>
                            </div>
        ...
        <div class="col-md-6 p-t-15 p-r-15">
            ...
            <textarea class="form-control" data-export="json">    @if(isset($variation)) {!! $variation->json_data
                !!}@else{"class":"classname","savedcss":".classname{animation-name:flash; animation-duration:1.2s; animation-delay:0.6s; }","classname":".classname","css":{"animation-name":"flash","animation-duration":"1.2s","animation-delay":"0.7s"}}@endif</textarea>
            <h5>css</h5>
