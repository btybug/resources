            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div aria-label="..." role="group" class="btn-group theme-btn-group label-Position">
                  <button class="btn btn-default left active" type="button"><i class="fa fa-arrow-left"></i></button>
                  <button class="btn btn-default top" type="button"><i class="fa fa-arrow-up"></i></button>
                  <button class="btn btn-default right" type="button"><i class="fa fa-arrow-right"></i></button>
                  <button class="btn btn-default none" type="button"><i class="fa fa-eye-slash"></i></button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="form-group datafrom"  data-type="Singleline" data-size="col-sm-12">
            <div class="row">
              ...
              <div data-fcontrol="input" class="col-sm-12" >
                <input type="text" name="singleline" class="form-control" id="singleline" placeholder="singleline">
              </div>
            </div>
          </div>
        </div>
