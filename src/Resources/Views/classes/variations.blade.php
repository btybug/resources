                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            ...
                            {{--text class</a>--}}
                                <a href="{{URL('/admin/resources/classes/create-class-variations',$classes->id)}}" class="btn btn-xs btn-success pull-right" style="color:#fff;">New Variation</a>
                            {{--@else--}}
                        ...
                        <table width="100%" class="table table-bordered m-0">
                            ...
                            @foreach($variations as $variation_data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{!! url('/admin/resources/classes/edit-class-variation',$variation_data->id) !!}" class="btn btn-primary btn-xs">&nbsp;<i class="fa fa-desktop"></i>&nbsp;</a>
                                        @if($variation_data->role)
                                            <a href="{!! url('/admin/resources/classes/delete-variation',$variation_data->id) !!}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure to delete')"> &nbsp;<i class="fa fa-trash"></i> &nbsp;</a>
                                                                @endif
                                    </td>
                                </tr>
                            @endforeach
