...
@section('content')
    <div class="row toolbarNav" style="padding-bottom:0px;">
        <div class="row">
            ...
            <div class="col-md-6 text-right"><a href="/admin/assets/classes/menus"
    ...
    <div class="row toolrowsection bootbox">
                    ...
                    <div role="tabpanel" class="tab-pane active style" id="style">
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8 p-0">
                                    <div class="form-inline p-0">
                                        ...
                                        <div class="checkbox radio ">
                                            <input type="radio" value="1" data-value=" a" data-rolecss="cssfor"
                                                   name="cssfor">
                                            <label> Top Menu </label>
                                        </div>

                                        <div class="checkbox radio">
                                            <input type="radio" value="2" data-value=" a:hover" data-rolecss="cssfor"
                                                   name="cssfor">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="fullSliderw settingSlider greenSlider m-t-5" data-css="margin"
                                         data-css-after="px" data-slide-min="0" data-slide-max="100" data-slide-step="1"
                                         data-slide-val="0"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" data-css="list-style" data-selector="liststyle"
                                            data-width="130px">
        ...
        <div class="col-md-6 p-t-15 p-r-15">
            ...
            <textarea class="form-control" data-export="json">    @if(isset($variation)) {!! $variation->json_data
                !!}@else{"class":"classname","savedcss":".classname{list-style:none;
                }","classname":".classname","css":{"list-style":"none"}}@endif</textarea>
            <h5>css</h5>
